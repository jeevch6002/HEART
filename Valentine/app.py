...
# 🎶 Background Music
with open("media/love_song.mp3", "rb") as audio_file:
...
with col1:
    st.image("media/pic1.jpg", caption="My favorite smile 💖")
with col2:
    st.image("media/pic2.jpg", caption="Us being us 😍")
with col3:
    st.image("media/pic3.jpg", caption="Forever memory 💫")
